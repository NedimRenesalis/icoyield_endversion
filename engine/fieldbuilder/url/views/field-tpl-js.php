    ...
    <div class="field-row" data-start-index="{index}" data-field-type="url">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-th-large"></span> <?= t('app', 'New url field');?></h3>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <?= Html::textInput($model->formName().'[url][{index}][sort_order]', html_encode($model->sort_order), ['class' => 'form-control', 'required' => true]); ?>
            ...
            <div class="panel-footer">
                <div class="pull-right">
                    <a href="javascript:;" class="btn btn-danger btn-flat btn-remove-url-field" data-field-id="0" data-message="<?= t('app', 'Are you sure you want to remove this field? There is no coming back from this after you save the changes.');?>"><?= t('app', 'Remove');?></a>
                </div>
