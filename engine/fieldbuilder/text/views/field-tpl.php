...
<div class="field-row" data-start-index="<?= $index;?>" data-field-type="text">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"><span class="glyphicon glyphicon-th-large"></span> <?= t('app', 'Text field');?></h3>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="form-group">
                        ...
                        <?= Html::textInput($model->formName().'[text]['.$index.'][sort_order]', html_encode($model->sort_order), ['class' => 'form-control']); ?>
        ...
        <div class="panel-footer">
            <div class="pull-right">
                <a href="javascript:;" class="btn btn-danger btn-flat btn-remove-text-field" data-field-id="<?= (int)$model->field_id;?>" data-message="<?= t('app', 'Are you sure you want to remove this field? There is no coming back from this after you save the changes.');?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
            </div>
